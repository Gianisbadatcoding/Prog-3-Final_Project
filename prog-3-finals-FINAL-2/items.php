...
<main class="main-content">
    ...
    <?php if (isset($_GET['error']) && $_GET['error'] == 'delete_failed'): ?>
        <div class="alert alert-error">
            <span class="alert-icon icon-error"></span>
                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <div class="action-buttons">
                                        <a href="view.php?id=<?php echo $row['item_id']; ?>" class="btn btn-view icon-view" title="View Details"></a>
                                        <?php if (isManager()): ?>
                                            <a href="update.php?id=<?php echo $row['item_id']; ?>" class="btn btn-edit icon-edit" title="Edit Product"></a>
                                            <a href="delete.php?id=<?php echo $row['item_id']; ?>" 
                                               class="btn btn-delete icon-delete" 
