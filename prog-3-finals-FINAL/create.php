            ...
            <form method="POST" action="" class="product-form">
                <div class="form-grid">
                    <div class="form-group-modern">
                        <label for="item_name" class="form-label">
                            <span class="label-icon icon-edit"></span>
                            Product Name
                    ...
                    <div class="form-group-modern">
                        <label for="price" class="form-label">
                            <span class="label-icon icon-money"></span>
                            Price
                            <span class="required">*</span>
                        </label>
                    ...
                    <div class="form-group-modern">
                        <label for="quantity" class="form-label">
                            <span class="label-icon icon-box"></span>
                            Quantity
                            <span class="required">*</span>
                        </label>
                        <input type="number" 
                    ...
                    <div class="form-group-modern">
                        <label for="isles" class="form-label">
                            <span class="label-icon icon-location"></span>
                            Aisle
                            <span class="required">*</span>
                        </label>
                        <input type="text" 
                    ...
                    <div class="form-group-modern">
                        <label for="shelf_position" class="form-label">
                            <span class="label-icon icon-list"></span>
                            Shelf Position
                            <span class="required">*</span>
                        </label>
                        <input type="text" 
                ...
                <div class="form-actions-modern">
                    <button type="submit" class="btn btn-primary">
                        <span class="icon-add-small"></span> Add Product
                    </button>
